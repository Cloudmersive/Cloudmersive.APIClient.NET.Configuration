...
(Get-Content '.\client\src\Cloudmersive.APIClient.NET.Configuration\Client\ApiClient.cs').replace('request.AddFile(param.Value.Name, param.Value.Writer, param.Value.FileName, param.Value.ContentType);', 'request.AddFile(param.Value.Name, param.Value.Writer, param.Value.FileName, param.Value.ContentLength, param.Value.ContentType);') | Set-Content '.\client\src\Cloudmersive.APIClient.NET.Configuration\Client\ApiClient.cs'
...
& C:\CodeSigning\sign.ps1 ./client/src/Cloudmersive.ApiClient.NET.Configuration/bin/Debug/Cloudmersive.APIClient.NET.Configuration.dll
